...
import com.bigvand.surfboard.utils.LiveDataCallAdapterFactory
 ...
 */
class RestApiService( private val mContext: Context) {
...
//            mContext.startActivity(Intent(mContext, SignUpActivity::class.java).apply {
//                flags =
