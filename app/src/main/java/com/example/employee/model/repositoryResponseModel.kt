...
@Entity(tableName = "RepositoryDetailsResponse")
...
//	@SerializedName("allow_auto_merge") val allow_auto_merge : Boolean?,
...
//	@SerializedName("license") val license : Licensed?,
...
data class Licensed (
	...
	@SerializedName("url") val url : String?,
	@SerializedName("s	pdx_id") val spdx_id : String?,
